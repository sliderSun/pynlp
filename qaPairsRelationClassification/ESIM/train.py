...
def train():
    ...
    premise_dev, premise_mask_dev, hypothesis_dev, hypothesis_mask_dev, y_dev = sentence2Index(arg.devset_path,
                                                                                               vocab_dict)
    ...
    for epoch in range(arg.num_epochs):
        ...
        batches = next_batch(premise_train, premise_mask_train, hypothesis_train, hypothesis_mask_train, y_train,
        ...
        for batch in batches:
            ...
            if total_batch % arg.eval_batch == 0:
                ...
                loss_val, acc_val = evaluate(sess, premise_dev, premise_mask_dev, hypothesis_dev, hypothesis_mask_dev,
                                             y_dev)
