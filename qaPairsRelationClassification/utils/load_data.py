...
# 生成字典
def generate_char_vocab(train_path,out_path, max_document_length):
    ...
    vocab_processor.fit_transform(np.concatenate((np.asarray(x1), np.asarray(x2)), axis=0))
...
if __name__ == '__main__':
    # load_all_data('../data/train.csv', data_size=100)
    generate_char_vocab('../data/train.csv',"F:\python_work\github\pynlp\qaPairsRelationClassification\data\\voc.txt", max_document_length=30)
