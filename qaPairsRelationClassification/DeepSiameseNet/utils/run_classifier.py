    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, logits):
                ...
                pred = tf.contrib.metrics.streaming_concat(logits)
                label_ids = tf.contrib.metrics.streaming_concat(label_ids)
                return {
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        train_spec = estimator.train(input_fn=train_input_fn, max_steps=num_train_steps, hooks=[early_stopping_hook])
    ...
    if FLAGS.do_eval:
        ...
        result = estimator.evaluate(input_fn=eval_input_fn, steps=eval_steps, throttle_secs=0)
        estimator.train_and_evaluate(estimator, train_spec, result)
