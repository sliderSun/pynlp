...
def word2vec_basic(log_dir):
    def load_data():
        ...
        df1 = pd.read_csv('F:\python_work\github\pynlp\qaPairsRelationClassification\data\\train.csv', encoding='utf-8-sig')
        df2 = pd.read_csv('F:\python_work\github\pynlp\qaPairsRelationClassification\data\dev.csv', encoding='utf-8-sig')
        df3 = pd.read_csv('F:\python_work\github\pynlp\qaPairsRelationClassification\data\\test.csv', encoding='utf-8-sig')
