...
from qaPairsRelationClassification.DRCN.model import DRCN
import tensorflow as tf
from qaPairsRelationClassification.DRCN import args
from qaPairsRelationClassification.utils.load_data import load_all_data
import pickle

p_c_index, h_c_index, p_w_index, h_w_index, p_w_vec, h_w_vec, same_word, label = load_all_data('../data/train.csv',
                                                                                               data_size=None)
p_c_index_evl, h_c_index_evl, p_w_index_evl, h_w_index_evl, p_w_vec_evl, h_w_vec_evl, same_word_evl, label_evl = load_all_data(
    '../data/dev.csv', data_size=2000)
...
model = DRCN(word_embedding=embedding)
...
with tf.Session(config=config)as sess:
    ...
    for epoch in range(args.epochs):
        ...
        with open('F:\python_work\github\pynlp\qaPairsRelationClassification\word2vec\output\word2vec\w2v.vec', 'wb')as file:
