...
from qaPairsRelationClassification.DIIN.model import DIIN
import tensorflow as tf
from qaPairsRelationClassification.DIIN import args
from qaPairsRelationClassification.utils.load_data import load_char_word_dynamic_data
import pickle

p_c_index, h_c_index, p_w_index, h_w_index, label = load_char_word_dynamic_data('../data/train.csv', data_size=None)
p_c_index_evl, h_c_index_evl, p_w_index_evl, h_w_index_evl, label_evl = load_char_word_dynamic_data('../data/dev.csv',
                                                                                                    data_size=2000)
...
model = DIIN(word_embedding=embedding)
