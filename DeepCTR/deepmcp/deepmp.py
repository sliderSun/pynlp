# DeepMP - Deep Matching and Prediction model
...
base_path = './tmp'
model_saving_addr = base_path + '/deepmp_' + str_txt + '/'
output_file_name = base_path + '/deepmp_' + str_txt + '.txt'
...
loss = loss_ctr + alpha * loss_match
