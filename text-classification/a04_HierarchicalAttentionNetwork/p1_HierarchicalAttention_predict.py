...
tf.flags.DEFINE_string("ckpt_dir","checkpoint_hier_atten_title/text_hier_atten_title_desc_checkpoint_0609/","checkpoint location for the model")
...
tf.flags.DEFINE_string("predict_target_file","checkpoint_hier_atten_title/text_hier_atten_title_desc_checkpoint_0609/zhihu_result_hier_atten_multilabel_b512_DROPOUT4.csv","target file path for final prediction")
