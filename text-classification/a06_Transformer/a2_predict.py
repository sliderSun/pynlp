...
tf.flags.DEFINE_integer("sequence_length",25,"max sentence length") #100-->25
...
tf.flags.DEFINE_string("predict_target_file","checkpoint_transformer/zhihu_result_transformer.csv","target file path for final prediction")
...
tf.flags.DEFINE_integer("decoder_sent_length",25,"length of decoder inputs")
