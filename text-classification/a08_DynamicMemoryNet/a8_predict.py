...
tf.flags.DEFINE_integer("num_epochs",1,"number of epochs to run.")
...
tf.flags.DEFINE_string("predict_target_file","../checkpoint_dynamic_memory_network/zhihu_result_dynamic_memory_network.csv","target file path for final prediction")
