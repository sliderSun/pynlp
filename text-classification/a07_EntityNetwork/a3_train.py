...
tf.flags.DEFINE_string("ckpt_dir","../checkpoint_entity_network2/","checkpoint location for the model")
tf.flags.DEFINE_integer("sequence_length",50,"max sentence length") #100
...
tf.flags.DEFINE_boolean("use_bi_lstm",True,"whether to use bi-directional lstm for encode of story and query")
