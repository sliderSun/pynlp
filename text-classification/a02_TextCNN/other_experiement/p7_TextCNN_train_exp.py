...
tf.flags.DEFINE_float("decay_rate", 0.65, "Rate of decay for learning rate.") #0.65一次衰减多少
...
tf.flags.DEFINE_integer("num_epochs",25,"number of epochs to run.")
...
tf.flags.DEFINE_integer("num_filters", 256, "number of filters") #256--->512
