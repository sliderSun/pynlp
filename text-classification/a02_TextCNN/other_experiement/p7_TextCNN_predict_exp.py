...
# tf.flags.DEFINE_string("predict_target_file","text_cnn_title_desc_checkpoint_exp/zhihu_result_cnn_multilabel_v6_exp.csv","target file path for final prediction")
