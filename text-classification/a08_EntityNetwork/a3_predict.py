...
tf.flags.DEFINE_string("ckpt_dir","../checkpoint_entity_network/","checkpoint location for the model")
tf.flags.DEFINE_integer("sequence_length",50,"max sentence length")
...
tf.flags.DEFINE_string("predict_target_file","../checkpoint_entity_network/zhihu_result_entity_network_multilabel_0712.csv","target file path for final prediction")
...
tf.flags.DEFINE_integer("block_size",20,"block size")
